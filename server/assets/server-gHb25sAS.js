...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DCKFSIvj.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-qa-ua8q8.js"),
		import("./start-OuyR9ZVG.js"),
...
//#endregion
export { createServerEntry, server_default as default, createMiddleware as n, server_exports as t };
